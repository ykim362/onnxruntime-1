...
void RunQLinearGlobalAveragePoolU8(
    ...
    uint8_t x_zero_point, float x_scale, uint8_t y_zero_point, float y_scale) {
...
TEST(QLinearGlobalAveragePool, Nhwc_1x8x8x256) {
  RunQLinearGlobalAveragePoolU8(false, 1, 256, 8, 8, 128, 1.0, 64, 2.0);
}
...
TEST(QLinearGlobalAveragePool, Nchw_3x256x8x8) {
  RunQLinearGlobalAveragePoolU8(true, 3, 256, 8, 8, 128, 1.0, 64, 1.0);
}

TEST(QLinearGlobalAveragePool, Nhwc_3x8x8x256) {
  RunQLinearGlobalAveragePoolU8(false, 3, 256, 8, 8, 128, 1.0, 64, 1.0);
}
